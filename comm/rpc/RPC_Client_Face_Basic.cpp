/*
  File: RPC_Client_Face_Basic.cpp
  Date: May, 2018
...
#include "comm/rpc/RPC_Client_Face_Basic.hpp"
...
bool RPC_Client_Face_Basic::detect_faces(cv::Mat &in, std::vector<cv::Rect> &out)
{
    ClientContext ctxt;
    ImageBase::Image img;
...
bool RPC_Client_Face_Basic::detect_face_lms(cv::Mat &in, std::vector<std::vector<cv::Point> > &out)
{
    ClientContext ctxt;
    ImageBase::Image img;
...
bool RPC_Client_Face_Basic::salient_point(cv::Mat &in, cv::Point &out)
{
    ClientContext ctxt;
    ImageBase::Image img;
    ImageBase::Point pt;
